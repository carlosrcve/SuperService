    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('cliente', 'Cliente'), ('conductor', 'Conductor de Viajes'), ('repartidor_domicilios', 'Repartidor de Domicilios'), ('administrador', 'Administrador')], default='cliente', max_length=30)),
